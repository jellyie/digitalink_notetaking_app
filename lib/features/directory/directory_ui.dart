                ...
                onPressed: () {
                  setState(() {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => CanvasUI(
                              widgetData: fileData.getWidgetData(
                                  fileData.getList().length - 1))),
                    );
                  });
                },
              ),
            ...
            child: Consumer<FileData>(
              ...
              return Container(
                  ...
                  child: GridView.count(
                    ...
                    children: [
                      for (int i = 0; i <= fileData.getList().length; i++)
                        i == fileData.getList().length
                            ? Card(
