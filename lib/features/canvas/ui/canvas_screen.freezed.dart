...
// import 'package:digitalink_notetaking_app/features/canvas/components/widgets/widget_data.dart';
...
// //Luowen: newly added imports
// import '../components/widgets/widget_model.dart';
// import '../components/widgets/widget_list.dart';
...
//         ),
//         body: ChangeNotifierProvider<WidgetData>(
//           create: (_) => WidgetData(),
//           child: Stack(
//             children: [
...
//               //Luowen: Display the widgets
//               Consumer<WidgetData>(builder: (context, WidgetData wData, child) {
//                 return WidgetList(wData: wData);
//               }),
...
//                             content:
//                                 Text('Gesture was recognized as.... $result'));
...
//                     //Luowen: add controls temporarily
//                     newWidgetTypes(context),
//                     Consumer<WidgetData>(
//                         builder: (context, WidgetData wData, child) {
//                       return ElevatedButton(
//                           onPressed: () {
//                             // add a new widget
//                             wData.addNewWidget(_newType);
//                           },
//                           child: const Text("Add new widget"));
//                     }),
//                     Consumer<WidgetData>(
//                         builder: (context, WidgetData wData, child) {
//                       return Container(
...
//                               labelText: 'Text input here',
//                             ),
//                             onSubmitted: (value) {
//                               wData.editContent(value);
//                             },
//                           ));
//                     }),
//                   ],
...
//   //Luowen: Following are added for temporary control choices
//   WidgetType? _newType = WidgetType.paragraph;
//   Widget newWidgetTypes(BuildContext context) {
//     return Row(
//       children: <Widget>[
//         const Text("paragraph"),
//         Radio<WidgetType>(
//           value: WidgetType.paragraph,
//           onChanged: (WidgetType? value) {
//             setState(() {
//               _newType = value;
//             });
//           },
